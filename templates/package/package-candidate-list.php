				...
				<div class="package-item">
					<div class="package-meta">
						<div class="jlt-col-40">
							<span class="jlt-package-title"><?php echo esc_html( $product->get_title() ) ?></span>
						</div>
						<div class="jlt-col-30">
							<span class="jlt-package-price"><?php echo $product->get_price_html(); ?></span>
						</div>
